"""Utility helpers for mkp_sci_com.

This module contains small utility functions used across the package. The
`split_beam` function replaces the previous module `mkp_sci_com.utils.split_beam`.
"""
import copy
...
def split_beam(
    ...
    for i, reim in enumerate(complex_part):
        for j, corr in enumerate(stokes):
            ...
            outdir = beam_file.parent if outdir is None else Path(outdir)
